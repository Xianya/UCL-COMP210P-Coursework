public class AllData
{
  ...
  private static Project [] allData;
  ...
  public void setVote(int projectNo, int[][] voteList)
  {
    if (voteList != null)
    {
      ...
      {
        Controller.fatalError("Invalid number of projects passed as the argument.");
      }
    }
  }
  ...
  public Project getProject(int n)
  {
    ...
    {
      Controller.fatalError("Invalid number of project passed as the argument.");
    }
    return project;
  }
